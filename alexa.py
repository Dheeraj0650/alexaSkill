...
calendar_id = "fcd31d4725c28aa79d693b969b104a248312b7404c1991ecc632611edf74b1b9@group.calendar.google.com"
...
class QuizHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        api_key = "Z5qEbbcWX2ZOeGNlKuDe0BIRosJLipPJUaEbmj07"
        limit = 10

        # url = "https://quizapi.io/api/v1/questions?apiKey=BpXQgLqyzIeYAT6GrC0kPjs1LWwTtwOe1izMzl9C&limit=10&category=Linux&difficulty=easy"

        url = f"https://quizapi.io/api/v1/questions?apiKey={api_key}&category={category}&difficulty={difficulty}&limit=10"
        
        # url = f"https://quizapi.io/api/v1/questions?apiKey={api_key}&limit={limit}&category={category}&difficulty={difficulty}"
        ...
        #         questions = quiz_questions["results"]
        # speech_text = "Welcome to the Quiz. Here is your first question: "
        # for i, question in enumerate(questions):
        #     speech_text += f"Question {i + 1}: {question['question']} "
        #     for j, answer in enumerate(question['answers']):
        #         speech_text += f"Option {j + 1}: {answer['answer']} "
        
        # speech_text += "Please provide your answer."
                
        
        speech_text = "Welcome to the Quiz. Here is your first question: ..."
        reprompt_text = "Please provide your answer."
        return (
            handler_input.response_builder
                .speak(speech_text)
                .ask(reprompt_text)
